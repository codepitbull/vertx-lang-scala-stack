...
The client of a Redis data source service is a `link:../../groovydoc/io/vertx/groovy/redis/RedisClient.html[RedisClient]`.

==== Publishing a Redis service

Publishing a Redis data source is a 2-step process:

1. create a record, using `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/RedisDataSource.html[RedisDataSource]`
2. publish the record

[source, groovy]
----
import io.vertx.groovy.servicediscovery.types.RedisDataSource
...
As stated in the previous section, how to access a data source depends on the data source itself. To build the
`link:../../groovydoc/io/vertx/groovy/redis/RedisClient.html[RedisClient]`, you can merge configuration: the record location, the metadata and a json object provided by
the consumer:
...
You can also use the `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/RedisDataSource.html[RedisDataSource]` class to the lookup and retrieval in one call:
...
register it using
`link:../../groovydoc/io/vertx/groovy/servicediscovery/ServiceDiscovery.html#registerServiceImporter(io.vertx.servicediscovery.spi.ServiceImporter,%20io.vertx.core.json.JsonObject)[registerServiceImporter]`.
